...
const CreatorBackground = inject('creatorStore')(
  observer(props => {
    ...
    return (
      <React.Fragment>
        <MDBCol md='7'>
          <SwithField
            showComponent={
              <MDBBox tag='h1' className='lead inline'>
                <MDBTypography className='inline' variant='h1' tag='h1'>
                  {username}
                </MDBTypography>
              </MDBBox>
            }
          ...
          <SwithField
            showComponent={
              <MDBBox tag='h2' className='lead inline'>
                <MDBTypography className='inline' tag='h2'>
                  {firstName}{' '}
                </MDBTypography>
              </MDBBox>
            }
